...
#
get_filename_component(filename "/src/src/common-utils/build/_deps/nlohmann_json_source-subbuild/nlohmann_json_source-populate-prefix/src/json.tar.xz" ABSOLUTE)
get_filename_component(directory "/src/src/common-utils/build/_deps/nlohmann_json_source-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-nlohmann_json_source-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-nlohmann_json_source-populate${i}")
